...
function encrypt(e, b) {
  b = b.toString();
  var a = CryptoJS.enc.Utf8.parse(b.MD5());
  var d = CryptoJS.enc.Utf8.parse(e);
  var c = CryptoJS.AES.encrypt(d, a, {
...
function decrypt(d, c) {
  try {
      c = c.toString();
      var b = CryptoJS.enc.Utf8.parse(c.MD5());
